...
export default function CalendarDayModal({ day, dayConsumption, onClose }: CalendarDayModalProps) {
  const { user } = useAuth();
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-[99999] p-4">
      <div className="bg-white/95 backdrop-blur-lg rounded-3xl shadow-2xl max-w-lg w-full max-h-[80vh] flex flex-col border border-white/20">
        {/* En-tête fixe */}
