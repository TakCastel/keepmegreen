...
export default function CalendarDayModal({ day, dayConsumption, onClose }: CalendarDayModalProps) {
  const { user } = useAuth();
  const { subscription, canAccessPeriod, loading: subscriptionLoading } = useSubscription();
  ...
  console.log('CalendarDayModal Debug:', {
    dayDate: dayDate.toISOString(),
    subscription: subscription?.plan,
    canAccess
  });

  // Afficher un skeleton pendant le chargement de l'abonnement
